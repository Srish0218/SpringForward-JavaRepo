...
//
//         bookWithMaxPrice = findBookWithMaximumPrice(books);
//        System.out.println(bookWithMaxPrice == null ? "No Book found with mentioned attribute." : bookWithMaxPrice);
//
//
//
//    }
//    public static Book findBookWithMaximumPrice(Book[] books){
//        Set<Book> booksWithMaxPrice = new HashSet<>();
//        if(books.length == 0){
//            return null;
//        }else{
...
//            }
//            for (Book book : books) {
//                if (maxPriceBook.getPrice() == book.getPrice()) {
//                    booksWithMaxPrice.add(book);
//                    booksWithMaxPrice.add(maxPriceBook);
//                }
//
//            }
//            if(booksWithMaxPrice.size() > 0){
//                return maxPriceBook;
//            }else {
